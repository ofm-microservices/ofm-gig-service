...
type FileMapper interface {
	...
	ToGetFileURLRequest(fileID string) *filev1.GetFileURLRequest
	ToGetFileURLResponse(res *filev1.GetFileURLResponse) string
	ToGetFileURLsRequest(fileIDs []string) *filev1.GetFileURLsRequest
	ToGetFileURLsResponse(res *filev1.GetFileURLsResponse) map[string]string

...
// WrapUnmarshalGigPublishedEventError annotates gig event decode failures.
func WrapUnmarshalGigPublishedEventError(err error) error {
	return fmt.Errorf("unmarshal gig published event: %w", err)
}

// WrapMarshalGigPublishedEventError annotates gig event encode failures.
func WrapMarshalGigPublishedEventError(err error) error {
	return fmt.Errorf("marshal gig published event: %w", err)
}
